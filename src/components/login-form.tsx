...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0 bg-black/60 backdrop-blur-md border border-orange-400/[0.3] shadow-2xl">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-8 md:p-10">
            <div className="flex flex-col gap-6">
              ...
              <Button type="submit" className="w-full bg-orange-400 text-black hover:bg-orange-300 font-medium py-2.5">
                Sign in
              </Button>
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="w-full bg-black/30 border-orange-400/[0.3] text-white hover:bg-black/40 hover:border-orange-300/[0.4]">
